...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with XPEER CODER",
	FIX: "Fix with XPEER CODER",
	IMPROVE: "Improve with XPEER CODER",
	ADD_TO_CONTEXT: "Add to XPEER CODER",
	NEW_TASK: "New XPEER CODER Task",
} as const
