...
export async function activate(context: vscode.ExtensionContext) {
	...
	if (!context.globalState.get("firstInstallCompleted")) {
		outputChannel.appendLine("First installation detected, opening XPEER CODER sidebar!")
		try {
			await vscode.commands.executeCommand("kilo-code.SidebarProvider.focus")

			outputChannel.appendLine("Opening XPEER CODER walkthrough")
	...
	// kilocode_change start - XPEER CODER specific registrations
	...
	// kilocode_change end - XPEER CODER specific registrations

	registerCodeActions(context)
	registerTerminalActions(context)

	// Allows other extensions to activate once XPEER CODER is ready.
